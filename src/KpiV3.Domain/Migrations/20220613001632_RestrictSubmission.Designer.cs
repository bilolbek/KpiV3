...
namespace KpiV3.Domain.Migrations
{
    ...
    [Migration("20220613001632_RestrictSubmission")]
    partial class RestrictSubmission
    {
            ...
            modelBuilder.Entity("KpiV3.Domain.Submissions.DataContracts.Submission", b =>
                {
                    ...
                    b.HasIndex("RequirementId", "EmployeeId")
                        .IsUnique()
                        .HasDatabaseName("ix_submissions_requirement_id_employee_id");
